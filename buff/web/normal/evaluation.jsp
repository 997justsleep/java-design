...
<table border="1">
    ...
    <tbody>
    <%
        List<Evaluation> evaluationList = (List<Evaluation>) session.getAttribute("evaList");
    ...
    <tr>
        ...
        <td>
            <%
                if(id == evaluation.getUserid()){
            %>
            <form action="/buff/normal/evaconnsell" method="POST">
...
<div>
    <%-- 上一页 --%>
    <% if (currentPage > 1) { %>
    <form action="<%=request.getContextPath()%>/normal/pagingEvaluation" method="POST" style="display:inline;">
